...
| File name                                                                                                                                               | Platform    |
|---------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| [hsweeper-v1.0.0-beta.4-windows-amd64.zip](https://github.com/borogk/hsweeper/releases/download/v1.0.0-beta.4/hsweeper-v1.0.0-beta.4-windows-amd64.zip) | Windows x64 |
| [hsweeper-v1.0.0-beta.4-linux-amd64.zip](https://github.com/borogk/hsweeper/releases/download/v1.0.0-beta.4/hsweeper-v1.0.0-beta.4-linux-amd64.zip)     | Linux x64   |
| [hsweeper-v1.0.0-beta.4-macos-arm64.zip](https://github.com/borogk/hsweeper/releases/download/v1.0.0-beta.4/hsweeper-v1.0.0-beta.4-macos-arm64.zip)     | macOS ARM64 |
...
```shell
go install github.com/borogk/hsweeper@v1.0.0-beta.4
```
